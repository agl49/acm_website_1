...
function updateSliderPosition (activeIndex,
  ...
  const sliderPosition = childWidth * moveBy
...
function PCarousel (props) {
  ...
  React.useEffect(() => {
    ...
    const trans = calcTransition(itemsToCalValues)
    const left = calcLeft(itemsToCalValues)
    const right = calcRight(itemsToCalValues)
    const top = calcTop(itemsToCalValues)
    ...
    // debugging
    const cR = getComputedStyle(document.documentElement).getPropertyValue('calcRightResult')
    ...
    <div>
      ...
      <div className={styled.carouselWrapper}>
        ...
        <div className={styled.styledCarousel}>
          ...
          <Arrow
            direction='left' onClick={() => onPrevStart(false,
              rest,
              activeIndex,
              setIsSwiped,
              setSwipedSliderPosition,
          ...
          <Arrow
            direction='right' onClick={() => onNextStart(false,
              rest,
              activeIndex,
              sliderPosition,
              setIsSwiped,
